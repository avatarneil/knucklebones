  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", width: width - 400, height: 1100 }}>
        ...
        >
          <div style={{ fontFamily: monoFont, fontSize: 24, color: theme.textMuted }}>
            Grid 1: 18 features
          </div>
          <div style={{ fontFamily: monoFont, fontSize: 24, color: theme.textMuted, marginTop: 200 }}>
            Grid 2: 18 features
          </div>
          <div style={{ fontFamily: monoFont, fontSize: 24, color: theme.textMuted, marginTop: 160 }}>
            Player: 1 feature
          </div>
          <div style={{ fontFamily: monoFont, fontSize: 24, color: theme.textMuted, marginTop: 40 }}>
            Die: 6 features
          </div>
        </div>
      </div>
